...
Описание ключей:
  ...
  -i, --ignore_case                 регистронезависимый поиск с помощью метода str.casefold()
  -b, --line_break                  удаление символов переноса строки
  -m, --match                       сравнивать слова на полное совпадение
                                    (формально, редакторское расстояние задаёт равным нулю)
  -l n, --length n                  изменяет редакторское расстояние (1 задана по умолчанию)
